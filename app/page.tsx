  ...
  return (
    <>
      <head>
        ...
        <meta
          name="description"
          content="Добро пожаловать на Парфюметрику! Здесь вы найдете все ароматы мира: обзоры на (общее количество парфбмов в базе) парфюмов, описания, подборки похожих ароматов и рейтинги брендов. Исследуйте наш каталог, изучайте отзывы и выбирайте идеальные ароматы, которые подчеркнут ваш стиль и создадут особое настроение."
        />
        <meta
          name="keywords"
