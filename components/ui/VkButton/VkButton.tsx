...
function GoogleIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    ...
    >
      {/* Outer Circle with VK Blue Color */}
      <circle cx="512" cy="512" r="512" style={{ fill: '#2787f5' }} />
      
      {/* Inner Path with White Color */}
      <path
        ...
        style={{ fill: '#fff' }} // Set fill color to white
      />
    </svg>
  );
}

export function VkButton(props: ButtonProps & React.ComponentPropsWithoutRef<'button'>) {
